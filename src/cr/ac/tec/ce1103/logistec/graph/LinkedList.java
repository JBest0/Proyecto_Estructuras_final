 ...
 * acceso O(n) pero inserción/eliminación eficiente en extremos.</p>
 *
...
public class LinkedList<T> {
    ...
    /**
     * Elimina y retorna el elemento en el índice indicado.
     *
     * @param index índice objetivo (base 0)
     ...
     *
     * @throws IndexOutOfBoundsException si la lista está vacía
     */
     ...
     *
     * @return último elemento removido
     * @throws IndexOutOfBoundsException si la lista está vacía
     */
    public T removeLast() {
    ...
    /**
     * Valida que un índice esté dentro del rango permitido.
     *
    ...
    /**
     * Obtiene el nodo en un índice especificado.
     *
     * @param index índice objetivo
     * @return nodo en ese índice
     */
