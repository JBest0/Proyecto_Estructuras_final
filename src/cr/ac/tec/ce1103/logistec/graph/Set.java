...
/**
 * Interfaz genérica para un conjunto (set) de elementos únicos.
 *
 * <p>Define el contrato básico para colecciones que no permiten
 * duplicados y proporcionan búsqueda, inserción y eliminación rápidas.</p>
 *
...
public interface Set<E> {
     ...
     * @return {@code true} si el conjunto se modificó (elemento no existía)
     */
